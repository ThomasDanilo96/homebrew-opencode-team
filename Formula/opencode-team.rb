class OpencodeTeam < Formula
  ...
  url "https://github.com/ThomasDanilo96/homebrew-opencode-team/archive/refs/tags/v0.1.15.tar.gz"
  ...
  test do
    assert_match "OpenCode Team 0.1.15", shell_output("#{bin}/opencode-team version")
