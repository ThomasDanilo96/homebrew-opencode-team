...
const safeStrings = new Set(["task_fingerprint", "benchmark_run_id", "benchmark_task_id", "variant", "complexity", "reasoning_effort", "risk", "codex_profile", "review_status", "tester_status", "verification_status", "error_code", "error_phase", "cache_status", "workspace_fingerprint", "test_task_id", "review_task_id", "gate_target", "tester_dispatch_state"]);
